    ...
    def begin_collection(self):
        ...
        for i, sheet_opts in enumerate(self.sheets):
            ...
            for j, contest_info in enumerate(contests, 1):
                ...
                assert contest_info.get('link'), (f'There is no link for the'
                ...
                start_limit = (datetime(*contest_info['startLimit'])
                               if contest_info.get('startLimit') else None)
                end_limit = (datetime(*contest_info['endLimit'])
